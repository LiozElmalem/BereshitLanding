...
public class Beresheet_Spacecraft {
	...
	public String toString() {
		...
		return "Time: "+dfff.format(time)+" , VS: "+dfff.format(vs)+" , HS: "+dfff.format(hs)+" , Dist: "+dfff.format(dist)+" , Alt: "+dfff.format(alt)+" , Ang: "+dfff.format(ang)+" , Weight: "+dfff.format(weight)+" , Acc: "+dfff.format(acc);
	}
}
